...
export default function SettingsPage() {
  ...
  if (loading) return (
    <div className="flex items-center justify-center h-64 opacity-20 animate-pulse">
       <Database size={40} className="text-[#3B82F6]" />
    </div>
  );
    ...
    <div className="space-y-12">
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <h2 style={{ fontSize: '22px', fontWeight: '700', color: '#F0F6FF' }}>Settings</h2>
          <p style={{ fontSize: '13px', color: '#6B8EAE', fontWeight: '400' }}>Admin override // Global registry</p>
        </div>
        <button 
          onClick={handleSave} 
          disabled={isSaving}
          ...
          <section className="space-y-6">
             <div className="space-y-1">
                <div className="flex items-center gap-3 text-[#3B82F6]">
                   <Key size={18} />
                   <h3 style={{ fontSize: '14px', fontWeight: '600', color: '#F0F6FF' }}>Identity & Access</h3>
                </div>
                <p style={{ fontSize: '13px', color: '#6B8EAE', fontWeight: '400' }}>Secure access tokens for cross-platform intelligence gathering and mission execution.</p>
             </div>
             
             <div className="space-y-5">
                <div className="space-y-1.5">
                  <label style={{ fontSize: '12px', fontWeight: '500', color: '#6B8EAE', marginBottom: '6px', display: 'block' }}>OpenAI API Protocol</label>
                  <input 
                     type="password"
                     style={{
                        width: '100%',
                ...
                <div className="space-y-1.5">
                  <label style={{ fontSize: '12px', fontWeight: '500', color: '#6B8EAE', marginBottom: '6px', display: 'block' }}>Anthropic API Terminal</label>
                  <input 
                     type="password"
                     style={{
                        width: '100%',
        ...
        <div style={{
          ...
          <section className="space-y-6">
             <div className="space-y-1">
                <div className="flex items-center gap-3 text-[#3B82F6]">
                   <Zap size={18} />
                   <h3 style={{ fontSize: '14px', fontWeight: '600', color: '#F0F6FF' }}>Operational Core</h3>
                </div>
                <p style={{ fontSize: '13px', color: '#6B8EAE', fontWeight: '400' }}>Global system parameters for swarm intelligence and background orchestration.</p>
             </div>

             <div className="space-y-5">
                <div className="space-y-1.5">
                  <label style={{ fontSize: '12px', fontWeight: '500', color: '#6B8EAE', marginBottom: '6px', display: 'block' }}>Ntfy Signal Bridge</label>
                  <input 
                     style={{
                        width: '100%',
                        padding: '10px 14px',
